// PegDodge - derived from the PathFinder sketch by Jo Wood,
// adapted for the cc26 Methods lecture: the ball launches itself
// from setup(), so there is no mouse interaction and no aiming line.
// MIT licence, as per the rest of this repository.
